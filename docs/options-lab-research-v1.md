...
当前持仓资料的截至日较旧，不能直接用于 2026-09-06 的个性化下单建议。它只
适合确定“熟悉池”，实时上线前必须重新同步持仓、现金、已有期权仓位和账户权限。

### 3.1 v1 熟悉池

| 层级 | 标的 | 初始定位 |
| --- | --- | --- |
| 核心 ETF | SPY、QQQ | 优先研究；分散、期权深度通常较好 |
| 核心大盘股 | MSFT、GOOGL、META、NVDA、JPM | 只有愿意长期持有且接货后不过度集中时进入 CSP 候选 |
...
登录后的一级标签为“期权实验室”，不放在公开 Daily 页面：
